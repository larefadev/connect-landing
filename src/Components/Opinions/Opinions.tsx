    ...
    const allTestimonials: Testimonial[] = [
        {
            ...
            content: "Estaba buscando una forma flexible de ganar más sin agregar trabajo extra. Con Connect, comencé a ganar en solo unos días. Es perfecto para mecánicos como yo que quieren aumentar ingresos sin manejar inventario.",
        ...
        },
        {
            ...
            content: "Manejar inventario y proveedores era estresante. Connect simplificó todo. Ahora vendo refacciones en línea sin almacenarlos, y mis clientes obtienen cotizaciones al instante.",
        ...
        },
        {
            ...
            content: "Connect me ayudó a hacer crecer mi negocio significativamente. No necesito invertir en inventario para completar reparaciones. La plataforma me conecta con proveedores a nivel nacional.",
        ...
        },
        {
            ...
            content: "Solíamos perder ventas por falta de inventario. Ahora con Connect, podemos ofrecer más de 250,000 refacciones y enviar a cualquier parte. Ha mejorado nuestra reputación y ganancias.",
        ...
        },
        {
            ...
            content: "Como mamá buscando ingresos extra, Connect fue la solución perfecta. Comencé con cero inversión, y ahora gano compartiendo un catálogo digital vía WhatsApp.",
            avatarSrc: "https://i.pravatar.cc/100?img=6"
        },
        {
            id: 6,
            name: "Miguel A.",
            role: "Propietario de Tienda de Refacciones",
            content: "Antes de Connect, luchaba por competir con tiendas más grandes. Ahora tengo acceso a un inventario masivo sin la carga financiera.",
            ...
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-10 px-4">
                    ...
                    <p className="text-gray-600 max-w-2xl mx-auto mb-8">
                        Personas reales. Ganancias reales. Vea cómo Connect impulsa a los revendedores en todo México.
                    </p>

                    {/* Estadística destacada */}
                    <div className="mb-12">
                        <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-8">
                            Más de 2,500 vendedores de autopartes en todo México confían en Connect.
                        </h3>
                                ...
                                <div className="flex flex-col md:flex-row">
                                    ...
                                    <div className="p-8 md:p-10 flex-1">
                                        <blockquote className="text-base md:text-lg text-gray-700 leading-relaxed mb-6">
                                            "Antes de Connect, perdía clientes cada semana porque no podía permitirme tener en stock todas las piezas que necesitaban. Los rechazaba o los hacía esperar días, lo que perjudicaba mi negocio y mi reputación. Con Connect, no necesito un almacén. Accedo a su enorme catálogo, establezco mis márgenes de beneficio y ellos se encargan de los envíos. Todo desde mi teléfono. En solo 3 meses, he aumentado mis ingresos en más de un 40 % y ahora atiendo a más clientes sin costes adicionales ni estrés."
                                        </blockquote>
                                        {/*<div>*/}
